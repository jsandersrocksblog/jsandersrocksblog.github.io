---
id: 1645
title: How to use Fiddler to Debug Azure App Service issues (with authentication)
date: 2016-11-11T14:13:13-05:00
author: jsanders
layout: post
guid: http://jsandersblog.azurewebsites.net/?p=1645
permalink: /2016/11/11/how-to-use-fiddler-to-debug-azure-app-service-issues-with-authentication-2/
opengraph_tags:
  - |
    <meta property="og:type" content="article" />
    <meta property="og:title" content="How to use Fiddler to Debug Azure App Service issues (with authentication)" />
    <meta property="og:url" content="https://blogs.msdn.microsoft.com/jpsanders/2016/11/11/how-to-use-fiddler-to-debug-azure-app-service-issues-with-authentication-2/" />
    <meta property="og:site_name" content="Http Client Protocol Issues (and other fun stuff I support)" />
    <meta property="og:description" content="Sometimes it is difficult to isolate Azure App Service issues to determine is the problem is the client or server.&nbsp; You can remove the client easily using a tool like Fiddler or Postman however is you are using authentication there are some tricks you need to use.&nbsp; I will demonstrate this with Azure Mobile Apps,..." />
    <meta property="og:image" content="/assets/images/2016/11/capture20161110105813225_thumb.png" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="How to use Fiddler to Debug Azure App Service issues (with authentication)" />
    <meta name="twitter:url" content="https://blogs.msdn.microsoft.com/jpsanders/2016/11/11/how-to-use-fiddler-to-debug-azure-app-service-issues-with-authentication-2/" />
    <meta name="twitter:description" content="Sometimes it is difficult to isolate Azure App Service issues to determine is the problem is the client or server.&nbsp; You can remove the client easily using a tool like Fiddler or Postman however is you are using authentication there are some tricks you need to use.&nbsp; I will demonstrate this with Azure Mobile Apps,..." />
    <meta name="twitter:image" content="/assets/images/2016/11/capture20161110105813225_thumb.png" />
