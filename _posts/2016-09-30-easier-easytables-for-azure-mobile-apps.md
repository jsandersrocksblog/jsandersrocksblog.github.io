---
id: 1535
title: Automating EasyTables for Azure Mobile Apps
date: 2016-09-30T14:21:27-05:00
author: jsanders
layout: post
guid: http://jsandersblog.azurewebsites.net/?p=1535
permalink: /2016/09/30/easier-easytables-for-azure-mobile-apps/
opengraph_tags:
  - |
    <meta property="og:type" content="article" />
    <meta property="og:title" content="Easier EasyTables for Azure Mobile Apps" />
    <meta property="og:url" content="https://blogs.msdn.microsoft.com/jpsanders/2016/09/30/easier-easytables-for-azure-mobile-apps/" />
    <meta property="og:site_name" content="Http Client Protocol Issues (and other fun stuff I support)" />
    <meta property="og:description" content="You could use the Azure CLI to create Azure Mobile Service tables for the node.js backend.&nbsp; You can no longer do this but there is a much easier solution.&nbsp; You can simply drop a .json file in the ‘Tables’ directory and when the app starts it will create the table in the database and make..." />
    <meta property="og:image" content="/assets/images/2016/09/capture20160930094545240_thumb.png" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="Easier EasyTables for Azure Mobile Apps" />
    <meta name="twitter:url" content="https://blogs.msdn.microsoft.com/jpsanders/2016/09/30/easier-easytables-for-azure-mobile-apps/" />
    <meta name="twitter:description" content="You could use the Azure CLI to create Azure Mobile Service tables for the node.js backend.&nbsp; You can no longer do this but there is a much easier solution.&nbsp; You can simply drop a .json file in the ‘Tables’ directory and when the app starts it will create the table in the database and make..." />
    <meta name="twitter:image" content="/assets/images/2016/09/capture20160930094545240_thumb.png" />
